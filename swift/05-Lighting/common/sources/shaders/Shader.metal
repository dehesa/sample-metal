...
vertex ProjectedVertex main_vertex(device Vertex* vertices [[buffer(0)]],
...
fragment float4 main_fragment(ProjectedVertex vert [[stage_in]], constant Uniforms &uniforms [[buffer(0)]]) {
